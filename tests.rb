...
class ApplicationTest < Minitest::Test
  ...
  def test_associate_lessons_with_courses_and_destroy_lessons_with_courses
    c = Course.create(name: "A Ruby Is Not A Gem", course_code: "GEO101")
  ...
  def test_associate_courses_with_course_instructors_but_not_destroy_with_course_instructors
    course = Course.create(name: "A Ruby Is Not A Gem", course_code: "GEO211")
  ...
  def test_associate_lessons_with_in_class_assignments
    c = Course.create!(name: "A Ruby Is Not A Gem", course_code: "GEO123")
    a = Assignment.create!(course_id: c.id, name: "WTF Ruby?", percent_of_grade: 0.2)
    l = Lesson.create!(name: "Defense Against Ruby Black Magic")
    a.lessons << l
    assert_equal a.lessons, [l]
    #  Assignment.lessons.find(l.in_class_assignment_id)
  end


  def test_course_has_many_readings
    c = Course.create(name: "A Ruby Is Not A Gem", course_code: "GEO711")
    l = Lesson.create(name: "Defense Against Ruby Black Magic")
    c.lessons << l
    r1 = Reading.create(caption: "Do You Believe In Magic?", url: "http://gilesbowkett.blogspot.com/2009/07/do-you-believe-in-magic.html", order_number: 7)
    r2 = Reading.create(caption: "Why Ruby on Rails won't become mainstream", url: "http://beust.com/weblog/2006/04/06/why-ruby-on-rails-wont-become-mainstream/", order_number: 8)
    l.readings << r1
    l.readings << r2
    assert c.readings.include?(r1)
    assert c.readings.include?(r2)
  end
  ...
  def test_terms_must_have_attributes
    s = School.create(name: "Introverts Uni")
  ...
  def test_assignments_have_attributes
    c = Course.create(name: "A Ruby Is Not A Gem", course_code: "GEO612")
  ...
  def test_assignments_are_unique_within_id
    c = Course.create(name: "A Ruby Is Not A Gem", course_code: "GEO444")
